  ...
  const handleBuyLoan = async () => {
    ...
    try {
      ...
      try {
        ...
        // Use the user's actual wallet address for this session
        // This should match what's showing in the UI
        const ownerWalletAddress = "AoY6tWSmjkvqYynKykSHQ5CK5pYoExaMQfqxAeB1sH9s";
        
        console.log("IMPORTANT - Using user-provided wallet address:", ownerWalletAddress);
